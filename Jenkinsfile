  ...
  stages {
    ...
    stage('DAST'){
            steps{
                ...
                sh "${DOCKER_EXEC} -v C:/Users/andre/Desktop/tarea_4/jenkins_home/tools:/zap/wrk/:rw -t owasp/zap2docker-live zap-full-scan.py -t ${TARGET} -f openapi -d -r zap_scan_report.html"
