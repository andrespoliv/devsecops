            ...
            steps{
        		...
        		script{
        		   ...
        		   env.TARGET = 'http://zero.webappsecurity.com/'
                    ...
                    sh '${DOCKER_EXEC} run --add-host="localhost:192.168.100.4" -v C:/Users/andre/Documents/Andrés Peña/Documentos/Programación/Cursos/Diplomado de herramientas en ciberseguridad USACH/Curso 3 - DevSecOps/Tareas/Tarea 4/Repo muestra/devsecops:/zap/wrk/:rw --rm -i owasp/zap2docker-stable zap-full-scan.py -t "http://zero.webappsecurity.com/" -I -r zap_baseline_report.html -l PASS'	
