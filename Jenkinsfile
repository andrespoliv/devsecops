  ...
  stages {
    ...
    stage('DAST'){
            steps{
                ...
                sh "${DOCKER_EXEC} -v --add-host='localhost:192.168.100.4' C:/Users/andre/Desktop/tarea_4/jenkins_home/tools:/zap/wrk/:rw --rm -i owasp/zap2docker-live zap-full-scan.py -t ${TARGET} -f openapi -d -r zap_scan_report.html"
